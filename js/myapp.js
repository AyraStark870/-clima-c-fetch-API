...
function consultarAPI(ciudad, pais){
  const appId = 'cd074a6bceb4385b435d6c4bc0efc5ed';//key
...
function mostrarClima(datos){
  const { name, main: { temp, temp_max, temp_min } } = datos;//destructuring de un obj dentro  de otro objeto
...
const KelvinACentigrados = grados =>  parseInt(grados-273.15)//funciones helpers
